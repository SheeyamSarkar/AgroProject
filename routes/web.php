...
Route::group(['prefix' => 'admin'], function(){
  ...
  Route::group(['prefix' => '/products'], function(){
    ...
    Route::get('/create', 'Backend\ProductsController@create')->name('admin.product.create');
     Route::get('/createvoice', 'Backend\ProductsController@createvoice')->name('admin.product.createvoice');


  //  Route::get('/create', 'Backend\ProductsController@createVoice')->name('admin.product.createvoice');
